 ...
 * =====================================================================
 * 
 * Responsabilidade: Sidebar com 21 botões para navegação no admin
 * Uso: include __DIR__ . '/includes/sidebar.php';
 * 
 * Funcionalidades:
 * - 21 links organizados por categorias
...
<aside class="sidebar">
    ...
    <!-- GRUPO 1: MÓDULOS PRINCIPAIS (9 botões) -->
    ...
    <!-- GRUPO 2: MÓDULOS OPERACIONAIS (12 botões - incluindo Gestão Fiscal) -->
    <div class="sidebar-group">
        <div class="sidebar-group-title">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo BASE_URL; ?>/app/admin/importar_extrato.php" 
               class="nav-item <?php echo $pagina_atual == 'importar_extrato.php' ? 'active' : ''; ?>">
                <i class="fas fa-cloud-upload-alt"></i> Importar Extrato
            </a>
            
            <!-- GESTÃO FISCAL - NOVO MÓDULO -->
            <a href="<?php echo BASE_URL; ?>/app/admin/gestao_fiscal.php" 
               class="nav-item <?php echo $pagina_atual == 'gestao_fiscal.php' ? 'active' : ''; ?>">
                <i class="fas fa-chart-line"></i> Gestão Fiscal
                <span style="background: #28a745; color: #fff; font-size: 10px; padding: 2px 6px; border-radius: 10px; margin-left: 8px;">NOVO</span>
            </a>
